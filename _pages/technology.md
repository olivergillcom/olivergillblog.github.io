    ...
    <div class="container max-width-lg cd-timeline__container">
        <div class="cd-timeline__block" id="gaming-pc">
          ...
          <div class="cd-timeline__content text-component">
            ...
            <hr>
            <h5>
              <a class="color-contrast-medium" style ="text-decoration: underline" href="https://uk.pcpartpicker.com/user/olig89/saved/CzWvf7">PCPartPicker List</a>
            </h5>
           <br>
            <ul class="computer">
              ...
              <li class="storage">Samsung 980 NVMe 1TB PCIe4.0 (OS)</li>
              <li class="storage">Sabrent Rocket 4.0 NVMe 1TB PCIe4.0 (Games)</li>
